...
<div class="row">
<div class="col-md-4"><div class="btnsection"><button onclick=window.open("newplayer.php")>Add Player</button></div></div>
<div class="col-md-4"><div class="btnsection"><button onclick=window.open("newteam.php")>Add Team</button></div></div>
