...
<div class="row" style="margin-top: 20px;">
<div class="col-md-6 text-center" style="font-size: 1.5em;">Balls Faced:</div>
<div class="col-md-6">
<input type="int" name="balls" style="border-bottom: 3px solid #0097c1;" required>
</div>
</div>
<div class="row" style="margin-top: 20px;">
<div class="col-md-6 text-center" style="font-size: 1.5em;">4's:</div>
<div class="col-md-6">
<input type="int" name="four" style="border-bottom: 3px solid #0097c1;" required>
</div>
</div>
<div class="row" style="margin-top: 20px;">
<div class="col-md-6 text-center" style="font-size: 1.5em;">6's:</div>
<div class="col-md-6">
<input type="int" name="six" style="border-bottom: 3px solid #0097c1;" required>
</div>
</div>
